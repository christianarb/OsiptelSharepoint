...
export class MaestroMaterial extends ListItem {
    ...
    constructor(
        ...
        public IdAplicaMedidaConcentracion = 7823,
        public MedidaConcentracion = '',
        public NombreGenerico = '',
        public IdPaisOrigen = -1,
        public IdAplicaPartidaArancelaria = 7818,
        ...
        public IdAplicaValorConcentracion = 7821,
    ...
    public static getColumnasSelect(): string[] {
        return [
            ...
            Variables.columns.NombreComercial
        ]
    }
    ...
    public setValoresPrueba() {
        ...
        this.MedidaConcentracion = 'no';
        this.NombreGenerico = 'prueba';
        this.IdPaisOrigen = 5941;
