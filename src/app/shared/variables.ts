...
export class Variables {
  ...
  public readonly ColumnasMaestroDesplegables = {
    ...
    AplicaEAN14: 'AplicaEAN14',
    AplicaPartidaArancelaria: 'AplicaPartidaArancelaria',
    AplicaValorConcentracion: 'AplicaValorConcentracion',
    AplicaMedidaConcentracion: 'AplicaMedidaConcentracion',
